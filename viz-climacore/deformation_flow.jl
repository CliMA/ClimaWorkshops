...
Sol_q3 =  Array{Fields.Field}(undef, length(times))
for t in 1:length(times)
    Sol_q3[t] = ClimaCore.level(sol.u[t].ρq3, 5)
end

ClimaCoreVTK.writepvd(joinpath(path, "q3"), times, (q3 = Sol_q3,), basis = :lagrange)
